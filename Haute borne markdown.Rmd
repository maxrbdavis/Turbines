...
Read data for full Haute Born Wind farm from 2017 to 2020, and the data description file or metadata:

```{r}
haute_all_2017_2020 <- read_csv2("~/Desktop/DATA/Haute Borne Wind Farm Data/la-haute-borne-data-2017-2020.csv")

data_description <- read_csv2("~/Desktop/DATA/Haute Borne Wind Farm Data/data_description.csv")
```
...
```{r}
write.csv(file = "haute_clean.csv", "~/Desktop/DATA/Haute Borne Wind Farm Data/Haute_output")
```
